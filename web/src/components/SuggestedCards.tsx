...
export default class SuggestedCards extends React.Component<SuggestedCardsProps> {
  render() {
      ...
      return (
        ...
        <div className={`break-inside relative overflow-hidden flex flex-col justify-between space-y-3 text-sm rounded-xl max-w-xs p-4 mb-4 bg-white shadow-lg text-black dark:text-white`} style={{ backgroundColor }}>

            {/* Card about and data */}
            <div className='flex items-center justify-between font-medium'>
                <span className='uppercase text-xs text-green-500'>{this.props.cardAbout}</span>
