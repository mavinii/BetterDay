  ...
  return (
    <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div className='flex flex-col items-center m-20'>
        <h1 className='mb-4 text-6xl font-extrabold text-gray-900 mt-3'>Designed for give you a BetterDay</h1>
      ...
      <div className='grid grid-cols-3 gap-6 mb-8'>
          ...
          {/* Cards 1 */}
          <div className="break-inside relative overflow-hidden flex flex-col justify-between space-y-3 text-sm rounded-xl max-w-full p-4 mb-4 bg-white shadow-lg text-black dark:bg-slate-800 dark:text-white">
