...
function App() {
  return (
    <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      <div className='max-w-[1344] max-auto flex flex-col items-center m-20'>
        <h1 className='mb-4 text-4xl font-extrabold text-gray-900 mt-3'>Designed for give you a BetterDay</h1>
      ...
      {/* Cards user input */}
      <section className="break-inside relative overflow-hidden flex flex-col justify-between space-y-3 text-sm rounded-xl max-w-[23rem] p-4 mb-4 bg-white shadow-lg text-black dark:bg-slate-800 dark:text-white">
